                    ...
                    <div class="row">
                        <div class="col-lg-12"> 
                            ...
                            <div class="form-group">
                                ...
                                laceholder="Informe o Título"></input>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="txtData" name="txtData" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" id="txtDescricao" name="txtDescricao" rows="10" class="form-control"
