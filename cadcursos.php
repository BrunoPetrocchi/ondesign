                                             ...
                                             <div class="col-lg-6">
                                                  <div class="form-group">
                                                       ...
                                                       <select class="form-control" id="usuarios" name="usuarios">
                                                            ...
                                                            <?php
                                                            $VarConsultaUsuarios = $clsUsuarios->ExibirUsuarios();
                                                            for ($i = 0; $i < count($VarConsultaUsuarios); $i++) {
                                                                 ?>
                                                                 <option value="<?php echo $VarConsultaUsuarios [$i]['IDUSUARIO']; ?>">
                                                                      <?php echo $VarConsultaUsuarios [$i]['NOME']; ?>
                                                                 </option>
                                                                 <?php
                                                            }
                                                            ?>
